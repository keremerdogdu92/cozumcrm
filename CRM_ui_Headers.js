 ...
 * v3.8.0
 * CHANGELOG:
 * - Added offer summary, totals, JSON payload, and SGK tracking columns for single-row trials.
 * - Retained existing analytics keys while ensuring quick entry writes stay within Denemeler.
 * - No Cihazlar schema changes for trial offers.
 */
const SHEET_HEADER_DEFS = Object.freeze({
  ...
  'Denemeler': {
    keys: [
      ...
      'offer_summary','offer_total_net','offers_json','uses_sgk',
    ...
    labels: [
      ...
      'Teklif Özeti','Teklif Toplam (Net)','Teklif JSON','SGK',

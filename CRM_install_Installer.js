 ...
 * v3.7.0
 * CHANGELOG:
 * - Added validations for trial contacts, device purpose, and slug-based trial updates.
 * - Keeps additive header ensure logic while leaving legacy formulas untouched.
 * - Preserved pricing mode setup for Satışlar with header-driven lookups.
 */
function installCRM(){
